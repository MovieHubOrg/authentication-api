...
public class BaseJwt implements Serializable {
    ...
    private Integer userKind = -1; // user type
    private String username = EMPTY_STRING;// username or order code
    private Boolean isSuperAdmin = false;

    public BaseJwt(Long accountId, String kind, String permission, Integer userKind, String username, Boolean isSuperAdmin) {
    ...
    public String toClaim() {
        ...
        return ZipUtils.zipString(accountId + DELIM + kind + DELIM + permission + DELIM  + userKind + DELIM + username + DELIM  + isSuperAdmin);
    }
